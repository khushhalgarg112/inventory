...
export interface BigBasketConfigProduct {
  name: string;
  matchers?: string[];
}

export interface BigBasketTracker {
  slug: string;
  bucketId?: string;
  type?: string;
  pages?: number[];
  ...
  products?: BigBasketConfigProduct[];
  label?: string;
}

export const BIGBASKET_TRACKERS: BigBasketTracker[] = [
  {
    slug: "iphone",
    bucketId: "92",
    pages: [1, 2, 3, 4],
...
export const PLATFORMS: Platform[] = [
  {
    ...
    products: [
      ...
      {
        id: "322039",
        name: "Vivo Y11 4/64 blue",
        url: "https://www.croma.com/vivo-y11-5g-4gb-ram-64gb-midnight-blue-/p/322039",
      },
      {
        id: "322041",
        name: "Vivo Y11 4/128 blue",
        url: "https://www.croma.com/vivo-y11-5g-4gb-ram-128gb-midnight-blue-/p/322041",
      },
      {
        id: "322042",
        url: "https://www.croma.com/vivo-y11-5g-4gb-ram-128gb-sunrise-gold-/p/322042",
        name: "Vivo Y11 4/128 Gold",
      },
      {
        id: "322040",
        name: "Vivo Y11 4/64 Gold",
        url: "https://www.croma.com/vivo-y11-5g-4gb-ram-64gb-sunrise-gold-/p/322040",
      },
      {
        id: "312575",
        name: "Vivo Y29 5G 4GB RAM 128GB Diamond Black",
